import { Img, Box, Divider, Stack, Text, Heading, Flex, Link as ChakraLink, List, ListItem, ListIcon } from '@chakra-ui/react'
import { CheckCircleIcon, LinkIcon } from '@chakra-ui/icons'

export const Footer = (props) => (
  <Box width="100%">
    <Divider width="100%" />
    <Flex wrap="wrap" width="100%" align="center" justify="center" as="footer" py="8rem" {...props}>
      <Img
        mx={{base:2, md:8}}
        boxSize="100px"
        objectFit="cover"
      ...
      <Stack borderRight={{base:"0px", md:"2px"}} pr={{base:0, md:8}} mb={{base: 4, md:0}} textAlign={{base:"center", md:"left"}} spacing={4} mx={4}>
        ...
        <Text>
          OSCA needs your feedback now more than ever.
        </Text>
      </Stack>      
      <List spacing={3} mx={4}>
        <ListItem>
